...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='YOLOv8-FDI-YOLO.yaml', help='model.yaml path')
    ...
    parser.add_argument('--batch', type=int, default=80, help='number of images per batch (-1 for AutoBatch)')
